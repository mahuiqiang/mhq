...
<table width="100%" cellspacing="1" cellpadding="2" id="list-table">
  ...
  <?php if(is_array($list)): foreach($list as $key=>$ls): ?><tr align="center" class="0" id="0_1" id = 'tr_1'>
    <td align="left" class="first-cell" style = 'padding-left="0"'>
            <img  src="/Public/Admin/images/menu_minus.gif" id="icon_0_1" width="9" height="9" border="0" style="margin-left:<?php echo ($ls['kg']*2); ?>em" />

            <span><a href="#" ><?php echo ($ls['cat_name']); ?></a></span>
        </td>
    <td width="10%">0</td>
    ...
    <td width="24%" align="center">
      <a href="#">转移商品</a> |
      <a href="<?php echo U('Admin/Cat/catedit',array('cat_id'=>$ls['cat_id']));?>">编辑</a> |
      <a href="<?php echo U('Admin/Cat/catedel',array('cat_id'=>$ls['cat_id']));?>" title="移除">移除</a>
