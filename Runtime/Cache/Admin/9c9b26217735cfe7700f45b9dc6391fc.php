...
<link href="/shop2/Public/Admin/styles/general.css" rel="stylesheet" type="text/css" />
<link href="/shop2/Public/Admin/styles/main.css" rel="stylesheet" type="text/css" />
      ...
      <form enctype="multipart/form-data" action="<?php echo U('Admin/Goods/goodsedit');?>" method="post" name="theForm" >
        ...
        <table width="90%" id="general-table" align="center">
          <tr>
            ...
            <td><input type="text" name="goods_name" value="<?php echo ($res['goods_name']); ?>" style="float:left;color:;" size="30" /></td>
          </tr>
          <tr>
            <td class="label">
            <a href="#" title="点击此处查看提示信息"><img  src="/shop2/Public/Admin/images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息"></a> 商品货号： </td>
            <td><input type="text" name="goods_sn" value="<?php echo ($res['goods_sn']); ?>" size="20"  /><span id="goods_sn_notice"></span><br />
          ...
          <tr>
            ...
            <td><input type="text" name="shop_price" value="<?php echo ($res['shop_price']); ?>" size="20" /></td>
          </tr>
        ...
        <table width="90%" id="mix-table" style="display:none" align="center">
            ...
            <td><input type="text" name="goods_weight" value="<?php echo ($res['goods_weight']); ?>" size="20" /> <select name="weight_unit"><option value="1" selected>千克</option><option value="0.001">克</option></select></td>
          </tr>
          <tr>
            <td class="label"><a href="#" title="点击此处查看提示信息"><img  src="/shop2/Public/Admin/images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息"></a> 商品库存数量：</td>
          ...
          <tr>
            <td class="label">
            <a href="#" title="点击此处查看提示信息"><img  src="/shop2/Public/Admin/images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息"></a> 商家备注： </td>
