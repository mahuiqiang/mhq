...
<table cellpadding="3" cellspacing="1">
  ...
  <?php if(is_array($goods)): foreach($goods as $key=>$g): ?><tr>
    ...
    <td align="center"><img  src="/Public/Admin/images/<?php echo ($g['is_hot']?'yes':'no'); ?>.gif"  /></td>
      ...
      <a href="<?php echo U('Admin/Goods/goodsedit',array('goods_id'=>$g['goods_id']));?>" title="编辑"><img  src="/Public/Admin/images/icon_edit.gif" width="16" height="16" border="0" /></a>
      <a href="#" title="复制"><img  src="/Public/Admin/images/icon_copy.gif" width="16" height="16" border="0" /></a>
      <a href="<?php echo U('Admin/Goods/goodsdel',array('goods_id'=>$g['goods_id']));?>"  title="回收站"><img  src="/Public/Admin/images/icon_trash.gif" width="16" height="16" border="0" /></a>
