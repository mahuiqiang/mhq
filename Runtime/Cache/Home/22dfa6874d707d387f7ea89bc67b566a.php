...
<div class="cagegoryCon clearfix">
  <?php if(is_array($lanmu)): foreach($lanmu as $key=>$lei1): if($lei1['parent_id'] == 0): ?><dl>
        ...
        <dd class="clearfix"> 
          <?php if(is_array($lanmu)): foreach($lanmu as $key=>$lei2): if($lei2['parent_id'] == $lei1['cat_id']): ?><p class=""><a href="<?php echo U('Home/Cat/cat',array('cat_id'=>$lei2['cat_id']));?>" title="<?php echo ($lei2['cat_name']); ?>" class="txtdot"><?php echo ($lei2['cat_name']); ?></a></p><?php endif; endforeach; endif; ?>        
        </dd>
...
<?php if(is_array($hots)): foreach($hots as $key=>$hot): ?><div class="goodsbox1">
				<div class="imgbox1"><a href="./goods.php-id=13.htm"><img  src="/shop2<?php echo ($hot[thumb_img]); ?>" alt="<?php echo ($hot['goods_name']); ?>"></a></div>
			 <a href="./goods.php-id=13.htm" title="<?php echo ($hot['goods_name']); ?>"><?php echo ($hot['goods_name']); ?></a><br>
              <font class="goodspice market">￥<?php echo ($hot['market_price']); ?>元</font>
			 			 <b class="f1">￥<?php echo ($hot['shop_price']); ?>元</b><br>
