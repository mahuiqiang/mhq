        ...
        <div class="contentNew">
          <div class="l_box">
            ...
            <form action="<?php echo U('Home/User/login');?>" method="post" name="loginForm" id="loginForm">
              ...
              <label> <span>验证码</span>
                <input type="text" class="inputBg" name="yzm" size="15">
              </label>
              <label> <span>看仔细哦</span>
                
              </label>
              <img src="<?php echo U('Home/User/yzm');?>" alt="">
                <div class="btns">
    ...
    <div class="us_login" style="float:left;">
      ...
      <div class="mbox" style="width:488px; height:370px; border:none;">
              ...
              <p>但注册之后您可以：</p>
					    ...
					    <p>3. 享受会员积分制度</p>
					    <p>4. 订阅本店商品信息</p>
					    <p><a href=''><img  src="/shop2/Public/Home/images/bnt_ur_regh.gif"></a></p>
				    </div>
				</div>
			</div>
      </div>
