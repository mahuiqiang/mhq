...
<link href="/shop2/Public/Home/css/style.css" rel="stylesheet" type="text/css">
</head>
<body>
...
<div class="page-header clearfix">
  <div class="block1 clearfix" style="position:relative;">
    <div class="logo fl"><a href="" title=""><img  src="/shop2/Public/Home/images/logo.gif" width="311" height="55" alt=""></a></div>
      <div class="btMap">
        <div class="search ">
...
<table class="floatTable" align="center" bgcolor="#e3e3e3" border="0" cellpadding="5" cellspacing="1" width="100%">
		<tbody><tr>
			...
			<tr>
			<td bgcolor="#ffffff">
				<a  target="_blank">ECSHOP模板中心68ecshop.com测试商品</a>
			</td>
			<td bgcolor="#ffffff">颜色:黑色 <br></td>
						<td align="right" bgcolor="#ffffff">￥3612.00元</td>
						<td class="price" align="right" bgcolor="#ffffff">￥3010.00元</td>
...
<div class="goodsTitle" style="background:#f6f6f6; border:#E3E3E3 solid 1px; border-bottom:none;">费用总计</div>
	...
	<table class="floatTable" align="center" bgcolor="#e3e3e3" border="0" cellpadding="5" cellspacing="1" width="100%">
	    <tbody><tr>
		    ...
		    <tr>
		    <td align="right" bgcolor="#ffffff">
		      商品总价: <font class="f1 f14b">￥3010.00元</font>
		    </td>
		    </tr>
		    <tr>
		    <td align="right" bgcolor="#ffffff"> 应付款金额: <font class="f1 f14b">￥3010.00元</font>
		    </td>
		  </tr>
		</tbody>
	</table>
...
<div style="margin:8px auto;" align="center">
		<input  src="/shop2/Public/Home/images/bnt_subOrder.gif" type="image">
...
<div class="block tc" style=""> <img  src="/shop2/Public/Home/images/serviceImg1.jpg"> </div>
