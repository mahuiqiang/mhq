...
<div class="block1">
  <div class="allMenu fl"> <a href="" title="" style="font-size:15px;" class="index current">首页</a> 
	...
	<div class="cagegoryCon clearfix">
 	<?php if(is_array($lanmu)): foreach($lanmu as $key=>$lei1): if($lei1['parent_id'] == 0): ?><dl>
        <dt><a href=""><?php echo ($lei1['cat_name']); ?></a></dt>
        <dd class="clearfix"> 

          <?php if(is_array($lanmu)): foreach($lanmu as $key=>$lei2): if($lei2['parent_id'] == $lei1['cat_id']): ?><p class=""><a href="" title="<?php echo ($lei2['cat_name']); ?>" class="txtdot"><?php echo ($lei2['cat_name']); ?></a></p><?php endif; endforeach; endif; ?> 
...
<?php if(is_array($his)): foreach($his as $key=>$h): ?><li>
       <div class="first">
        <div class="fl">
        <font style="color:#F00; font-weight:bold"></font> <a href="<?php echo U('Home/Goods/goods',array('goods_id'=>$h['goods_id']));?>" title="">
        <?php echo ($h['goods_name']); ?></a>
        </div>
...
<div class="clearfix modContent"> 
    ...
    <div class="clearfix grid">
      ...
      <?php if(is_array($goods)): foreach($goods as $key=>$goods): ?><div class="goodsbox1" style="margin: 5px 9px 8px 8px;*margin:5px 6px 10px 14px;">
        <div class="imgbox1"><a href="<?php echo U('Home/goods/goods',array('goods_id'=>$goods['goods_id']));?>"><img  src="<?php echo ($goods['thumb_img']); ?>" alt="<?php echo ($goods['goods_name']); ?>"></a></div>
        <a href="<?php echo U('Home/goods/goods',array('goods_id'=>$goods['goods_id']));?>" title="<?php echo ($goods['goods_name']); ?>"><?php echo ($goods['goods_name']); ?></a><br>
        <font class="market">￥<?php echo ($goods['market_price']); ?>元</font> 
        <b class="f1">￥<?php echo ($goods['market_price']); ?>元</b><br>
