...
<table class="floatTable" align="center" bgcolor="#e3e3e3" border="0" cellpadding="5" cellspacing="1" width="100%">
	...
	<?php if(is_array($che)): foreach($che as $key=>$c): ?><tr>
			<td bgcolor="#ffffff">
				<a  target="_blank"><?php echo ($c['goods_name']); ?></a>
			</td>
			<td bgcolor="#ffffff">颜色:黑色 <br></td>
						<td align="right" bgcolor="#ffffff">￥3612.00元</td>
						<td class="price" align="right" bgcolor="#ffffff">￥<?php echo ($c['shop_price']); ?>元</td>
			<td align="right" bgcolor="#ffffff"><?php echo ($c['num']); ?></td>
			<td class="price" align="right" bgcolor="#ffffff">￥<?php echo ($c['num']*$c['shop_price']); ?>元</td>
